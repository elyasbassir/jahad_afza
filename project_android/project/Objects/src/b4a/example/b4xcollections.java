...
public static b4a.example.b4xbitset  _vvv6(anywheresoftware.b4a.BA _ba,int _size) throws Exception{
...
public static b4a.example.b4xorderedmap  _vvv7(anywheresoftware.b4a.BA _ba) throws Exception{
...
public static b4a.example.b4xorderedmap  _vvv0(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.collections.List _keys,anywheresoftware.b4a.objects.collections.List _values) throws Exception{
...
_m._vvvvvvvvvvv3 /*String*/ (_keys.Get(_i),_values.Get(_i));
 }
};
 };
...
public static b4a.example.b4xset  _vvvv1(anywheresoftware.b4a.BA _ba) throws Exception{
...
public static b4a.example.b4xset  _vvvv2(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.collections.List _values) throws Exception{
