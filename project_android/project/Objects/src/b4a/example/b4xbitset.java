...
_vvvvvvvv3 = new int[(int) (__c.Bit.ShiftRight(_vvvvvvvv4,(int) (5))+1)];
;
 //BA.debugLineNum = 60;BA.debugLine="End Sub";
return "";
}
public boolean  _vvvvvvv7(int _index) throws Exception{
int _dindex = 0;
int _offset = 0;
int _blockvalue = 0;
...
_blockvalue = _vvvvvvvv3[_dindex];
...
public String  _vvvvvvvv1(int _index,boolean _value) throws Exception{
int _dindex = 0;
int _offset = 0;
int _blockvalue = 0;
...
_vvvvvvvv3[_dindex] = _newblockvalue;
